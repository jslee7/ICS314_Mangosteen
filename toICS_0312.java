...
{
	PrintWriter pw;
	String sStart, sEnd,classification, location;
	String summary;
	int priority;
//takes user input and generates a .ics file for them to use in calender
	public toICS(PrintWriter pw,String summary,String sStart,String sEnd,int priority,String classification, String location) throws IOException
	{
		this.pw = pw;
	...
	public static void main(String[] args) 
	{
		PrintWriter pw;
		String fileName = "";
		String sStart,sEnd,classification,sPriority, location;
		String summary;
		...
		try 
		{
			while(check == 1)
			{
				...
				//I feel like we should say name of the event rather? SUMMARY field is actually the subject/name of the event
				//and we should add a DESCRIPTION field for the summay. they should not name the fields this way....
				...
				//create event
				toICS event = new toICS(pw,summary,sStart,sEnd,priority,classification,location);
